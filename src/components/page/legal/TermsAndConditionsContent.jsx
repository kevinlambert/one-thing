    ...
    <div className="document-previewer-wrapper-a717db">
      ...
      <div data-custom-class="body">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              the website <bdt className="question">1thing.co</bdt> (the{" "}
              <bdt className="block-component" />'<strong>Site</strong>'
              <bdt className="else-block" />)
              <bdt className="block-component" />,{" "}
              <bdt className="statement-end-if-in-editor" />
              <bdt className="block-component" />
          ...
          >
            ...
            >
              ...
              <bdt className="block-component">
                email at <bdt className="question">onething@1thing.co</bdt>
          ...
          >
            ...
            >
              ...
              <strong>ou</strong>'<bdt className="else-block" />
              ), and <bdt className="question">ONE Thing</bdt>, concerning your
          ...
          >
            ...
            >
              <bdt className="question">
                User will be notified within the app.
              </bdt>
              <bdt className="statement-end-if-in-editor" />
              <bdt className="statement-end-if-in-editor" />
            </span>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#mobile">
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  <bdt className="block-component" />
                  12. MOBILE APPLICATION <bdt className="block-component" />
                  LICENCE
                  <bdt className="else-block" />
                  <bdt className="statement-end-if-in-editor" />
                </span>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <bdt className="block-component" />
            <a data-custom-class="link" href="#addclause">
              <span data-custom-class="body_text">
                28. <bdt className="question">CEASE</bdt>
              </span>
            </a>
            <bdt className="statement-end-if-in-editor">
              <span data-custom-class="body_text" />
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className="question">onething@1thing.co</bdt>. If we ever
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              of the Services
              <bdt className="block-component" /> and possibly through
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            <span style={{ fontSize: 15 }}>
              ...
              account.
              <bdt className="block-component" /> Your cancellation will take
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="question">onething@1thing.co</bdt>
              <bdt className="block-component" />.
              <bdt className="statement-end-if-in-editor" />
            </span>
          </div>
        ...
        >
          ...
          >
            ...
            <bdt className="block-component" />
            'Third-Party Websites'
            <bdt className="else-block" />) as well as articles, photographs,
            ...
            the <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
            Websites or the{" "}
            <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Content.
        ...
        >
          ...
          <bdt className="question">ONE Thing</bdt> and yourself both agree to
          submit to the non-exclusive jurisdiction of the courts of{" "}
          <bdt className="question">London</bdt>, which means that you may make
        ...
        >
          <span style={{ fontSize: 15 }}>
            ...
            <bdt className="else-block" />) brought by either you or us
            (individually, a <bdt className="block-component" />
            ...
            least <bdt className="question">thirty (30)</bdt> days before
                  ...
                  <bdt data-type="body">
                    ...
                    >
                      <bdt data-type="conditional-block">
                        ...
                        >
                          <bdt className="block-component" />
                          <bdt className="question">$0.00 USD</bdt>
                          <bdt className="statement-end-if-in-editor">
                            <bdt className="block-component" />
                          </bdt>
                        </bdt>
        ...
        >
          <bdt className="question">
            <span style={{ fontSize: 15 }}>
              At any point the ONE Thing app and service may terminate. You have
              no recourse to any liability or claim against ONE Thing, it's
